...
const handleWithdrawal = (amount) => {
    if (amount <= dummyUser.balance) {
        ...
        console.log(chalk.magenta(displayMessage(`You remaining balance is ${remainingBalance}!`)));
    }
    else {
...
const handleDeposit = (amount) => {
    if (amount <= dummyUser.balance) {
        ...
        console.log(chalk.green(displayMessage(`Deposit of ${initialAmount} successful!`)));
        console.log(chalk.magenta(displayMessage(`You new balance is ${newBalance} now!`)));
    }
};
